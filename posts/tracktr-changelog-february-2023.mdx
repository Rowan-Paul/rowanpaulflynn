...
For admins, we now added a review queue where reviews from users will appear so that we can approve or delete them. Currently the approved state does not figure in to showing the review, all reviews continue to be shown whetever they are approved or not. This is just a way to make sure every review gets checked and there isn't any spam on the site. We also a few new stats to the admin page; unique viewers and how many reviews people have left.
